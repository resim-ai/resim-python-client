...
T = TypeVar("T", bound="ListBatchesResponse200")


@_attrs_define
class ListBatchesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_batches_response_200 = cls(
            batches=batches,
            next_page_token=next_page_token,
        )

        list_batches_response_200.additional_properties = d
        return list_batches_response_200
