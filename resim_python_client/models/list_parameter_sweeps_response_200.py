...
T = TypeVar("T", bound="ListParameterSweepsResponse200")


@_attrs_define
class ListParameterSweepsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_parameter_sweeps_response_200 = cls(
            next_page_token=next_page_token,
            sweeps=sweeps,
        )

        list_parameter_sweeps_response_200.additional_properties = d
        return list_parameter_sweeps_response_200
