...
T = TypeVar("T", bound="ListMetricsDataForMetricIDsResponse200")


@_attrs_define
class ListMetricsDataForMetricIDsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_metrics_data_for_metric_i_ds_response_200 = cls(
            metrics_data_and_i_ds=metrics_data_and_i_ds,
            next_page_token=next_page_token,
        )

        list_metrics_data_for_metric_i_ds_response_200.additional_properties = d
        return list_metrics_data_for_metric_i_ds_response_200
