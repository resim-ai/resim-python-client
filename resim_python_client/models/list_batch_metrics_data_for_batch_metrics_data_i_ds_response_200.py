...
T = TypeVar("T", bound="ListBatchMetricsDataForBatchMetricsDataIDsResponse200")


@_attrs_define
class ListBatchMetricsDataForBatchMetricsDataIDsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_batch_metrics_data_for_batch_metrics_data_i_ds_response_200 = cls(
            batch_metrics_data=batch_metrics_data,
            next_page_token=next_page_token,
        )

        list_batch_metrics_data_for_batch_metrics_data_i_ds_response_200.additional_properties = d
        return list_batch_metrics_data_for_batch_metrics_data_i_ds_response_200
