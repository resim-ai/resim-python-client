...
if TYPE_CHECKING:
    from ..models.list_batch_metrics_data_for_batch_metric_i_ds_response_200_batch_metrics_data_and_i_ds_item import (
        ListBatchMetricsDataForBatchMetricIDsResponse200BatchMetricsDataAndIDsItem,
    )


T = TypeVar("T", bound="ListBatchMetricsDataForBatchMetricIDsResponse200")


@_attrs_define
class ListBatchMetricsDataForBatchMetricIDsResponse200:
    """
    Attributes:
        batch_metrics_data_and_i_ds (Union[Unset,
            List['ListBatchMetricsDataForBatchMetricIDsResponse200BatchMetricsDataAndIDsItem']]):
        next_page_token (Union[Unset, str]):
    """

    batch_metrics_data_and_i_ds: Union[
        Unset, List["ListBatchMetricsDataForBatchMetricIDsResponse200BatchMetricsDataAndIDsItem"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for batch_metrics_data_and_i_ds_item_data in _batch_metrics_data_and_i_ds or []:
            batch_metrics_data_and_i_ds_item = (
                ListBatchMetricsDataForBatchMetricIDsResponse200BatchMetricsDataAndIDsItem.from_dict(
        ...
        list_batch_metrics_data_for_batch_metric_i_ds_response_200 = cls(
            batch_metrics_data_and_i_ds=batch_metrics_data_and_i_ds,
            next_page_token=next_page_token,
        )

        list_batch_metrics_data_for_batch_metric_i_ds_response_200.additional_properties = d
        return list_batch_metrics_data_for_batch_metric_i_ds_response_200
