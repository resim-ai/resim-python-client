...
T = TypeVar("T", bound="ListMetricsBuildsResponse200")


@_attrs_define
class ListMetricsBuildsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_metrics_builds_response_200 = cls(
            metrics_builds=metrics_builds,
            next_page_token=next_page_token,
        )

        list_metrics_builds_response_200.additional_properties = d
        return list_metrics_builds_response_200
