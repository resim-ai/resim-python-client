...
T = TypeVar("T", bound="ListViewSessionsResponse200")


@_attrs_define
class ListViewSessionsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_view_sessions_response_200 = cls(
            next_page_token=next_page_token,
            view_sessions=view_sessions,
        )

        list_view_sessions_response_200.additional_properties = d
        return list_view_sessions_response_200
