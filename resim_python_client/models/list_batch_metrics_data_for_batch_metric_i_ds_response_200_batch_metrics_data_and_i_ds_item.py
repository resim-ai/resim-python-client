...
T = TypeVar("T", bound="ListBatchMetricsDataForBatchMetricIDsResponse200BatchMetricsDataAndIDsItem")


@_attrs_define
class ListBatchMetricsDataForBatchMetricIDsResponse200BatchMetricsDataAndIDsItem:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_batch_metrics_data_for_batch_metric_i_ds_response_200_batch_metrics_data_and_i_ds_item = cls(
            batch_metric_id=batch_metric_id,
            batch_metrics_data=batch_metrics_data,
        )

        list_batch_metrics_data_for_batch_metric_i_ds_response_200_batch_metrics_data_and_i_ds_item.additional_properties = (
            d
        )
        return list_batch_metrics_data_for_batch_metric_i_ds_response_200_batch_metrics_data_and_i_ds_item
