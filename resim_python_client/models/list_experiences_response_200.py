...
T = TypeVar("T", bound="ListExperiencesResponse200")


@_attrs_define
class ListExperiencesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_experiences_response_200 = cls(
            experiences=experiences,
            next_page_token=next_page_token,
        )

        list_experiences_response_200.additional_properties = d
        return list_experiences_response_200
