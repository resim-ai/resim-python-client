...
class ListMetricsForMetricIDsResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_metrics_for_metric_i_ds_response_200 = cls(
            metrics=metrics,
            next_page_token=next_page_token,
        )

        list_metrics_for_metric_i_ds_response_200.additional_properties = d
        return list_metrics_for_metric_i_ds_response_200
