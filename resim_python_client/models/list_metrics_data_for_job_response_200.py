...
T = TypeVar("T", bound="ListMetricsDataForJobResponse200")


@_attrs_define
class ListMetricsDataForJobResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_metrics_data_for_job_response_200 = cls(
            metrics_data=metrics_data,
            next_page_token=next_page_token,
        )

        list_metrics_data_for_job_response_200.additional_properties = d
        return list_metrics_data_for_job_response_200
