...
T = TypeVar("T", bound="AddBatchMetricsDataToBatchMetricResponse201")


@_attrs_define
class AddBatchMetricsDataToBatchMetricResponse201:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        add_batch_metrics_data_to_batch_metric_response_201 = cls(
            batch_metric_id=batch_metric_id,
            batch_metrics_data_i_ds=batch_metrics_data_i_ds,
        )

        add_batch_metrics_data_to_batch_metric_response_201.additional_properties = d
        return add_batch_metrics_data_to_batch_metric_response_201
