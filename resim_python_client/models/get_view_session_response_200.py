...
T = TypeVar("T", bound="GetViewSessionResponse200")


@_attrs_define
class GetViewSessionResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_view_session_response_200 = cls(
            view_metadata=view_metadata,
            view_object=view_object,
        )

        get_view_session_response_200.additional_properties = d
        return get_view_session_response_200
