...
T = TypeVar("T", bound="ListExperienceTagsResponse200")


@_attrs_define
class ListExperienceTagsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_experience_tags_response_200 = cls(
            experience_tags=experience_tags,
            next_page_token=next_page_token,
        )

        list_experience_tags_response_200.additional_properties = d
        return list_experience_tags_response_200
