...
T = TypeVar("T", bound="ListBuildsForBranchResponse200")


@_attrs_define
class ListBuildsForBranchResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_builds_for_branch_response_200 = cls(
            builds=builds,
            next_page_token=next_page_token,
        )

        list_builds_for_branch_response_200.additional_properties = d
        return list_builds_for_branch_response_200
