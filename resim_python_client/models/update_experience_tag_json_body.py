...
T = TypeVar("T", bound="UpdateExperienceTagJsonBody")


@_attrs_define
class UpdateExperienceTagJsonBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_experience_tag_json_body = cls(
            experience_tag=experience_tag,
            update_mask=update_mask,
        )

        update_experience_tag_json_body.additional_properties = d
        return update_experience_tag_json_body
