...
T = TypeVar("T", bound="ListBranchesForProjectResponse200")


@_attrs_define
class ListBranchesForProjectResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        list_branches_for_project_response_200 = cls(
            branches=branches,
            next_page_token=next_page_token,
        )

        list_branches_for_project_response_200.additional_properties = d
        return list_branches_for_project_response_200
