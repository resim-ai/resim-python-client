...
T = TypeVar("T", bound="CreateViewUpdateResponse201")


@_attrs_define
class CreateViewUpdateResponse201:
    """
    Attributes:
        id (Union[Unset, str]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_view_update_response_201 = cls(
            id=id,
            mcap=mcap,
            view=view,
        )

        create_view_update_response_201.additional_properties = d
        return create_view_update_response_201
